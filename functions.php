...
function site_scripts()
{
   if (!is_admin()) {
      ...
      // wp_enqueue_script('siteScriptsHead'); // Enqueue it!
      wp_register_script('siteScripts', get_template_directory_uri() . '/js/scripts-min.js', array(), '1.0.0', true); // Custom scripts in foot
      wp_enqueue_script('siteScripts'); // Enqueue it!
   }
}
...
// Change the Gravity Forms button type
add_filter( 'gform_submit_button', 'form_submit_button', 10, 2 );
function form_submit_button( $button, $form ) {
   return "<button class='btn btn--dark btn--left' id='gform_submit_button_{$form['id']}'><span>Submit</span></button>";
}

// Change the Gravity Forms button type for Contact form
add_filter( 'gform_submit_button_1', 'contact_form_submit_button', 10, 2 );
function contact_form_submit_button( $button, $form ) {
   return "<div class='btn-row'><button class='btn btn--dark btn--left' id='gform_submit_button_{$form['id']}'><span>Submit Request</span></button></div>";
}

// Change the Gravity Forms button type for Subscribe form
add_filter( 'gform_submit_button_2', 'subscribe_form_submit_button', 10, 2 );
function subscribe_form_submit_button( $button, $form ) {
   return "<button class='btn btn--dark' id='gform_submit_button_{$form['id']}'><span>Subscribe</span></button>";
}
